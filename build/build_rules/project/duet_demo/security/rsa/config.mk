...
$(NAME)_SOURCE_GROUP := lib rsa security/duet
$(NAME)_SOURCE_DIR := $(SOURE_ROOT)

$(NAME)_SOURCE := \
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/rsa/code/main.c \
...
$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/rsa/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/cfg/ram.ini
