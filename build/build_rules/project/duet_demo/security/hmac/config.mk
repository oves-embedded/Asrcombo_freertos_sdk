...
$(NAME)_SOURCE_GROUP := lib hmac security/duet

$(NAME)_SOURCE := \
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/hmac/code/main.c \
...
$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/hmac/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/hmac/cfg/ram.ini
