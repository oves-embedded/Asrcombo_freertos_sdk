...
$(NAME)_SOURCE_GROUP := lib hash security/duet
$(NAME)_SOURCE_DIR := $(SOURE_ROOT)

$(NAME)_SOURCE := \
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/hash/code/main.c \
...
$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/hash/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/hash/cfg/ram.ini
