...
$(NAME)_SOURCE_GROUP := platform common peripheral security
...
$(NAME)_SOURCE := \
    ...
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/ccm/code/main.c \
...
$(NAME)_CFLAGS := -DLEGA_A0V2 -DDX_CC_TEE -DRND_INTEGTEST -DCC_HW_VERSION=0xF0 -DDLLI_MAX_BUFF_SIZE=0x10000 -DSSI_CONFIG_TRNG_MODE=0
$(NAME)_CFLAGS += -DOS_NOT_SUPPORT

$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/ccm/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/security/ccm/cfg/ram.ini
