...
$(NAME)_SOURCE := \
    ...
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/spi/code/main.c \
    ...
    $($(NAME)_SOURCE_DIR)/peripheral/duet/src/duet_spi.c \

$(NAME)_INC_PATH := \
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/spi/code \
...
$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/spi/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/spi/cfg/ram.ini
