...
$(NAME)_SOURCE := \
    ...
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/i2c/code/main.c \
    ...
    $($(NAME)_SOURCE_DIR)/peripheral/duet/src/duet_i2c.c \
    $($(NAME)_SOURCE_DIR)/peripheral/duet/src/duet_timer.c \
    $($(NAME)_SOURCE_DIR)/peripheral/duet/src/duet_dma.c \

$(NAME)_INC_PATH := \
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/i2c/code \
...
$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/i2c/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/i2c/cfg/ram.ini
