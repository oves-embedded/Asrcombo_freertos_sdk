...
$(NAME)_SOURCE := \
    ...
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/rtc/code/main.c \
    ...
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/rtc/code/duet_cal.c \
    $($(NAME)_SOURCE_DIR)/peripheral/duet/src/duet_timer.c \

$(NAME)_INC_PATH := \
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/rtc/code \
...
$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/rtc/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/rtc/cfg/ram.ini
