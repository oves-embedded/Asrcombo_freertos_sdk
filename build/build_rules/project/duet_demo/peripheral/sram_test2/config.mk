...
$(NAME)_SOURCE := \
    ...
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/sram_test2/code/main.c \
    ...
    $($(NAME)_SOURCE_DIR)/peripheral/duet/src/duet_ram_layout.c \

$(NAME)_INC_PATH := \
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/sram_test2/code \
...
$(NAME)_CFLAGS := -D_LEGA_CM4_ -D_IC_CODE_ -DLEGA_A0V2
$(NAME)_CFLAGS +=

$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/sram_test2/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/sram_test2/cfg/ram.ini
