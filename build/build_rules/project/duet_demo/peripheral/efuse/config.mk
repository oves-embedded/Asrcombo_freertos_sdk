...
$(NAME)_SOURCE := \
    ...
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/efuse/code/main.c \
    ...
    $($(NAME)_SOURCE_DIR)/common/duet/duet_common.c

$(NAME)_INC_PATH := \
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/efuse/code \
...
$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/efuse/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/efuse/cfg/ram.ini
