...
$(NAME)_SOURCE := \
    ...
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/psram/code/main.c \
    ...
    $($(NAME)_SOURCE_DIR)/peripheral/duet/src/duet_psram.c \

$(NAME)_INC_PATH := \
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/psram/code \
...
$(NAME)_CFLAGS := -D_LEGA_CM4_ -D_IC_CODE_ -DLEGA_A0V2 -DPSRAM_CHIP_LY68L6400
$(NAME)_CFLAGS +=

$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/psram/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/psram/cfg/ram.ini
