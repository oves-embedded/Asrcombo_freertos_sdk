...
$(NAME)_SOURCE := \
    ...
    $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/adc/code/main.c \
    ...
    $($(NAME)_SOURCE_DIR)/peripheral/duet/src/duet_adc.c \
...
$(NAME)_CFLAGS := -DDUET_CM4
$(NAME)_CFLAGS +=

$(NAME)_LINK_LD := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/adc/cfg/gcc.ld
$(NAME)_LINK_INI := $($(NAME)_SOURCE_DIR)/demo/duet_demo/peripheral/adc/cfg/ram.ini
