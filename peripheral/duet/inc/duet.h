...
#define PERI_SOFT_RESET_REG_BASE0            (SYS_CON_REG_BASE + 0x820)
#define PERI_SOFT_RESET_REG_BASE1            (SYS_CON_REG_BASE + 0x824)
#define PERI_SOFT_RESET_CLEAR_REG_BASE0      (SYS_CON_REG_BASE + 0x828)
#define PERI_SOFT_RESET_CLEAR_REG_BASE1      (SYS_CON_REG_BASE + 0x82C)
