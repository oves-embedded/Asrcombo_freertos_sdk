...
int32_t duet_spi_finalize(duet_spi_dev_t *spi)
{
    ...
    {
        tmp_value = REG_RD(PERI_CLK_DIS_REG1) & (~(SPI1_BUS_CLK_EN|SPI1_PERI_CLK_EN));
        REG_WR(PERI_CLK_DIS_REG1, (tmp_value | (SPI1_BUS_CLK_EN|SPI1_PERI_CLK_EN)));
    }
    else
    {
        tmp_value = REG_RD(PERI_CLK_DIS_REG1) & (~(SPI2_BUS_CLK_EN|SPI2_PERI_CLK_EN));
        REG_WR(PERI_CLK_DIS_REG1, (tmp_value | (SPI2_BUS_CLK_EN|SPI2_PERI_CLK_EN)));
    }
