...
enum JL_THREAD_PRI{
  JL_THREAD_PRI_DEFAULT = 5, /*priority: default*/
  JL_THREAD_PRI_LOWEST = 0,  /*priority: lowest*/
  JL_THREAD_PRI_LOW = 10,     /*priority: low*/
  JL_THREAD_PRI_HIGH = 20,    /*priority: high*/
  JL_THREAD_PRI_HIGHEST = 31, /*priority: highest*/
} ;
