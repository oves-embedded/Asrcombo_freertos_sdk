...
DS1302_TIME_TypeDef Read_T;
DS1302_TIME_TypeDef Write_T;
...
extern duet_gpio_dev_t g_duet_gpio6_cs, g_duet_gpio7_clk,g_duet_gpio8_mosi,g_duet_gpio9_miso;
...
{  
    ...
    duet_gpio_output_low(&g_duet_gpio7_clk);
    Delay(2);//延时大约2us  
...
{  
   ...
   // HAL_GPIO_WritePin(DS_CE_GPIO_Port,DS_CE_Pin,GPIO_PIN_SET);  ;             //ds1302rst=1;  
    ...
    g_duet_gpio8_mosi.config = DUET_INPUT_HIGH_IMPEDANCE;
    ...
    {  
       ...
       duet_gpio_output_low(&g_duet_gpio7_clk);
	   duet_gpio_input_get(&g_duet_gpio8_mosi,&io_state);
