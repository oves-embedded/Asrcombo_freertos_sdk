...
enum csvc_att_db_handles_test
{
    CSVC_IDX_att_ppid_CHAR ,
    CSVC_IDX_att_ppid_VAL,
    CSVC_IDX_att_ppid_CFG,
    
    CSVC_IDX_att_opid_CHAR,
    CSVC_IDX_att_opid_VAL,
    CSVC_IDX_att_opid_CFG,

	CSVC_IDX_att_flid_CHAR,
    CSVC_IDX_att_flid_VAL,
    CSVC_IDX_att_flid_CFG,

	CSVC_IDX_att_ver_CHAR,
    CSVC_IDX_att_ver_VAL,
    CSVC_IDX_att_ver_CFG,
