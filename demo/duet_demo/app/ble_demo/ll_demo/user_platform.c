...
void df_init(void)
{
    duet_pinmux_config(PAD8,PF_DF); // P08 - DD_ANTSW_SEL[0]
    duet_pinmux_config(PAD9,PF_DF); // P09 - DD_ANTSW_SEL[1]
}
#endif //PLF_DF
...
void pta_init(void)
{
    duet_pinmux_config(PAD13,PF_PTA); // P13 - PTA_BLE_PTI0
    duet_pinmux_config(PAD14,PF_PTA); // P14 - PTA_BLE_PTI1
    duet_pinmux_config(PAD23,PF_PTA); // P23 - PTA_BLE_PTI2
    duet_pinmux_config(PAD24,PF_PTA); // P24 - PTA_BLE_PTI3
    duet_pinmux_config(PAD19,PF_PTA); // P19 - PTA_BLE_INPROCESS
    duet_pinmux_config(PAD20,PF_PTA); // P20 - PTA_WLAN_ABORT
