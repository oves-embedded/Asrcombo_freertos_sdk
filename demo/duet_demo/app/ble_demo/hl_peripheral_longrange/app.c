...
static void app_ble_config_extended_advertising()
{
    ...
    //param.prop =SONATA_GAP_EXT_ADV_PROP_DIR_CONN_MASK;
    param.max_tx_pwr = 0xE2;//Todo
    param.filter_pol = SONATA_ADV_ALLOW_SCAN_ANY_CON_ANY;
    param.prim_adv_intv_min = 32;
    param.prim_adv_intv_max = 32;
    param.prim_chnl_map = 0x07;
    param.prim_phy = SONATA_GAP_PHY_125KBPS;
    param.second_max_skip = 0;
//    param.second_phy = GAP_PHY_LE_CODED - 1;//3; //GAPM_PHY_TYPE_LE_CODED;
    param.second_phy = SONATA_GAP_PHY_125KBPS;
...
void app_init(void)
{
    ...
    //uint8_t bt_addr[]={0x55,0x44,0x33,0x22,0x11,0x00};
    //uint8_t bt_addr[]={0x00,0x11,0x22,0x33,0x44,0x55};
    ...
    //sonata_set_bt_address(bt_addr, sizeof(bt_addr));
    app_ble_on();
