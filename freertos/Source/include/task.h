...
typedef struct xTASK_STATUS
{
    ...
    StackType_t *pxStackEnd;         /* Points to the highest adress of the task's stack area. */
    StackType_t *pxStackTop;         /* Points to the location of the last item placed on the tasks stack. */
