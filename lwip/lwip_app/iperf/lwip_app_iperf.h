...
#define UDP_SEND_BUFSIZE 1470
#define SEND_BUFSIZE UDP_SEND_BUFSIZE//(TCP_SEND_BUFSIZE>UDP_SEND_BUFSIZE?TCP_SEND_BUFSIZE:UDP_SEND_BUFSIZE)
#define MAX_PCB_NUM  4

#ifdef CFG_PLF_DUET
//#define IPERF_SOCKET              //default close ,open it in duet platform when tests complete.
#endif
...
extern struct lwip_iperf_config_t txiperf_config;
extern struct lwip_iperf_config_t rxiperf_config;
...
int transfer_utxperf_data(int neg);
